const LISTA =
{
    Adicionar: () =>
    {
        ...
        item.appendChild(LISTA.ObterCabecalho(paciente, medico, procedimento));
        item.appendChild(LISTA.ObterPagamento(convenio));
    ...
    ObterCabecalho: (paciente: string, medico: string, procedimento: string): HTMLDivElement =>
    {
    ...
    ObterPagamento: (convenio: string): HTMLDivElement =>
    {
